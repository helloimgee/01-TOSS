...
const TeamSection01 = forwardRef((props, ref) => {
  return (
    <section className="teamSection01" ref={ref}>
      <div className="teamSection01-wrap">
        <div className="teamSection01-wrap-text">
          <p className="teamSection01-wrap-text-title">
            변화를 열망하는 사람들이 모여, <br /> 역사에 남을만한 변화를
            만듭니다.
          </p>
          <ul className="teamSection01-wrap-text-list">
            <li>
              <p>누적 가입자 수</p>
              <p>2,200만 +</p>
            </li>
          ...
          <p className="teamSection01-wrap-text-date">2022년 4월 기준</p>
        </div>
      </div>
      <div className="teamSection01-graph">
        <svg
          viewBox="0 0 500 500"
