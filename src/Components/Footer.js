  ...
  return (
    <div className="footer">
      <div className="footerWrap">
        <div className="footerWrap-footerItems">
          <div className="footerWrap-footerItems-service">
            <ul>
              <li>서비스</li>
              <li>공지사항</li>
              <li>자주 묻는 질문</li>
          ...
          <div className="footerWrap-footerItems-company">
            <ul>
              <li>회사</li>
              <li>회사소개</li>
              <li>토스페이먼츠</li>
          ...
          <div className="footerWrap-footerItems-inquiry">
            <ul>
              <li>문의</li>
              <li>사업 제휴</li>
              <li>광고 문의</li>
          ...
          <div className="footerWrap-footerItems-cs">
            <ul>
              <li>고객센터</li>
